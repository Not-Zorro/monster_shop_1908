...
RSpec.describe 'item show page', type: :feature do
  ...
  it 'has a list of reviews' do
    review_1 = @chain.reviews.create(user_id: @user.id, title: "Great place!", content: "They have cool bike stuff and I'd recommend them to anyone.", rating: 5)
    review_2 = @chain.reviews.create(user_id: @user.id, title: "Okay place :/", content: "Brian's cool and all but not a good selection of things", rating: 3)

...
describe Item, type: :model do
  ...
  describe "methods" do
    before(:each) do
      ...
      @user = User.create!(name: 'Customer Sally', address: '123 Fake St', city: 'Denver', state: 'Colorado', zip: 80111, email: 'user@abuser.com', password: 'password' )
      @user_2 = User.create!(name: 'Second Customer', address: '123 Fake St', city: 'Denver', state: 'Colorado', zip: 80111, email: 'user2@abuser.com', password: 'password' )
      ...
      @review_2 = @chain.reviews.create!(user_id: @user_2.id, title: "Cool shop!", content: "They have cool bike stuff and I'd recommend them to anyone.", rating: 4)
      @review_3 = @chain.reviews.create!(user_id: @user_2.id, title: "Meh place", content: "They have meh bike stuff and I probably won't come back", rating: 1)
      @review_4 = @chain.reviews.create!(user_id: @user_2.id, title: "Not too impressed", content: "v basic bike shop", rating: 2)
      @review_5 = @chain.reviews.create!(user_id: @user_2.id, title: "Okay place :/", content: "Brian's cool and all but just an okay selection of items", rating: 3)
    end
